...
//				try {
//					WebElement chatbotNav = wait.until(ExpectedConditions.presenceOfElementLocated(By.id("_am8gmj89kNavbar")));
//					if (chatbotNav.isDisplayed()) {
//						System.out.println("🤖 Chatbot detected.");
//
//						// Wait for the chatbot question to appear
//						WebElement chatbotQuestion = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='botMsg msg']//span[contains(text(), 'What is your total years of IT experience?')]")));
//						System.out.println("🤖 Chatbot question: " + chatbotQuestion.getText());
//
//						// Answer the question
//						WebElement answerInput = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@id='sendMsg__am8gmj89kInputBox']//div[@class='sendMsg']")));
//						answerInput.sendKeys("5"); // Replace "5" with the actual years of experience
//						System.out.println("🤖 Answered the chatbot question.");
//
//						// Submit the answer
//						WebElement sendButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='sendMsg__am8gmj89kInputBox']//div[@class='sendMsg']")));
//						sendButton.click();
